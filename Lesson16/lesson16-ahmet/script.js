...
filterNegative([2, -1, 0, -3, 8, 4, -5, 5]);
...
removeDuplicates([3, 3, 8, 8, 0, 1, 4, 5, 5]);
console.log("-------");
/*
...
reverseWords("I will understand JavaScript function");
console.log("-------");
/*
...
filterLongWords(["kayseri", "Javascript", "cat", "map", "hat", "circle"], 5);
console.log("-------");
...
countOccurrences(
  ["Ahmet", "Mehmet", "Pamuk", "Ahmet", "Talisca", "Ahmet"],
  "Ahmet"
);
console.log("-------");
/*
...
findWordsWithLetter(
  ["Fenerbahce", "Galatasaray", "Kayserispor", "Beşiktas"],
  "e"
);
...
manageQueue(["Mehmet", "Ahmet", "Pamuk", "Duman"], "Puffy");
