...
console.log('Ex.1',' sum of the numbers', thirdNumber + fourthNumber);
...
// 3. Declare variables s=10 and d=4. Log the result of s-d, s*d, and s/d.
const s = 10;
const d = 4;

console.log('Ex. 3:', 's-d=', s - d, 's*d=', s * d, 's/d=', s / d);
...
Math.floor(3.7);
Math.ceil(3.2);
console.log('Ex.12', 'Math.floor(3.7)=', Math.floor(3.7), 'Math.ceil(3.2)=', Math.ceil(3.2));
...
console.log('Ex.14','counter', counterr++);
console.log('counter', 2+3);
console.log('counter', counterr);
...
let y = 10;
let z = 15;
console.log('Ex.17', 'Total sum=', j + y + z);  
...
console.log('Ex.18', 'divisionResult=', divisionResult, 'differenceResult=', differenceResult);
// 19. Declare firstName and lastName. Create fullName by concatenating them with a space and log it.
const firstName ='Erkan';
const lastName = 'KARAPACA';
const fullName = firstName + ' ' + lastName;
console.log('Ex.19', 'fullName=', fullName);
...
let counter=0;
counter++;
console.log('Ex.22', 'After counter++=', counter);
counter +=1;
console.log('Ex.22', 'After counter +=1=', counter);
counter = counter +1;
console.log('Ex.22', 'After counter = counter +1=', counter);

// 23. Declare initialTemperature=20. Increase it by 5 and log the result.
let initialTemperature =20;
initialTemperature +=5;
console.log ('Ex.23','initialTemperature is=',initialTemperature);

// 24. Declare numberEx9=6. Increment it using the prefix ++ operator and log both the variable and the incremented value.
let numberEx9 =6;
console.log('Ex.24', 'Before incrementing numberEx9=', numberEx9);
console.log('Ex.24', 'After incrementing ++numberEx9=', ++numberEx9); 
// 25. Declare numberEx10=8. Increment it using the postfix ++ operator and log both the original variable and the incremented value.
let numberEx10 =8;
console.log('Ex.25', 'Before incrementing numberEx10=', numberEx10);
console.log('Ex.25', 'After incrementing numberEx10++=', numberEx10++); 
console.log('Ex.25', 'Value of numberEx10 after postfix increment=', numberEx10);
// 26. Declare numberEx11=-3. Increment it by 1 using prefix ++, then multiply the result by 2 and log the final value.
let numberEx11 = -3;
console.log('Ex.26', 'After incrementing ++numberEx11 and multiplying by 2=', ++numberEx11 * 2);
// 27. Declare a=2 and b=3. Increment a using the prefix ++ operator, then add b to the result and log it.
let a = 2;
let b = 3;
console.log('Ex.27', 'After incrementing ++a and adding b to the result=', ++a + b);