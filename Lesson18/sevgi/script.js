...
applyDiscount(code) {
  const discounts = { SAVE10: 0.10, SAVE20: 0.20, SAVE30: 0.30 };
...
shoppingCart1.removeItem("Keyboard"); // olmayan ürün testi

console.log("Discounted (SAVE10):", shoppingCart1.applyDiscount("SAVE10"));
console.log("Discounted (SAVE20):", shoppingCart1.applyDiscount("SAVE20"));
console.log("Discounted (WRONG):", shoppingCart1.applyDiscount("NOPE"));