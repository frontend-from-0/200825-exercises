...
const namesAndGrades = studentsExercise5.map(student => student.name + ' ' + student.grade);
...
const mailOfUsers = usersExercise8.map(user => user.name + ': ' + user.email);
console.log(mailOfUsers);
...
const currencyOfPrices = pricesExercise10.map(price => price + '$');
console.log(currencyOfPrices);