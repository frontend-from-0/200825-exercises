...
const maxNumber = numbersEx2.reduce((acc, currentVal) => {
    if(currentVal > acc){
        return currentVal;
    }else {
        return acc;
...
console.log(numbersEx2, 'maximum number is ', maxNumber);
...
const total = numbersEx4.reduce((acc, currentVal) => acc + currentVal);
const averageOfNumbers = total / numbersEx4.length;
