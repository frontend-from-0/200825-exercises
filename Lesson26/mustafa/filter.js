...
const sentencesWithTenWordsOrLess = sentencesExercise5.filter(sentence => sentence.split(' ').length <= 10);
console.log(sentencesWithTenWordsOrLess);
...
const usersWithoutJ = usersExercise10.filter(user => !user.name.toLowerCase().startsWith('j'));
console.log(usersWithoutJ);