...
const studentsNotes = studentsExercise5.map(student => student.name + " "+ student.grade);
...
const sentenceToWord = sentencesExercise7.map(sentence => sentence.split(" "));
console.log(sentenceToWord);
// Exercise 8:
...
const mail = usersExercise8.map(student => student.name + ": " + student.email)
console.log(mail)
// Exercise 9:
...
const books = booksExercise9.map(book => book.author + " - " + book.title)
console.log(books)
// Exercise 10:
...
const currency = pricesExercise10.map(number => number+"$");
