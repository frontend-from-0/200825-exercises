...
const lengthAbove10 = sentencesExercise5.filter(sentence => sentence.trim().split(" ").length > 10)
console.log(lengthAbove10)
...
const quantity0 = productsExercise6.filter(product => product.quantity === 0);
