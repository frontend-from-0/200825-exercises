...
const sentencesWithTenOrLessWords = sentencesExercise5.filter(sentencesExercise5 => sentencesExercise5.split(' ').length <= 10);
console.log(sentencesWithTenOrLessWords); 
...
const wordsWithFiveOrLessChar = wordsExercise8.filter(word => word.length <= 5);
console.log (wordsWithFiveOrLessChar);
...
const userNameWithoutJ = usersExercise10.filter(user => !user.name.startsWith("J"));
console.log (userNameWithoutJ);