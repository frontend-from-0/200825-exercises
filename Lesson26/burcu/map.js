...
const extractNamesAndGrades = studentsExercise5.map(
  (student) => student.name + " " + student.grade,
);
console.log(extractNamesAndGrades);
...
const convertNumbers = numbersExercise6.map((number) => number.toString());
...
const extractEmailAddresses = usersExercise8.map((user) => user.email);
console.log(extractEmailAddresses);
...
console.log(booksTitlesAndAuthors);
