...
function Card({ className, size = "default", ...props }: CardProps) {
  return (
    <div
      ...
      className={cn(
        [
          "group/card flex flex-col gap-6 overflow-hidden rounded-2xl",
          "bg-card py-6 text-sm text-card-foreground",
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-base font-medium text-card-foreground",
        className,
      )}
      {...props}
    />
