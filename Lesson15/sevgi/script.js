...
normalizeEmail("seVgi@gmail.CoM");
...
checkFileExtension("exercises.pdf");
checkFileExtension("samplefolder.png");
...
truncateString("Ayse is learning JS", 8);
truncateString("Ayse is learning JS", 19);
...
checkProtocol("https://eloquentJavascript.net");
checkProtocol("htt://eloquentjavascript.net");
...
startsWithA("Apple is the pretty healthy fruit");
...
replaceCharacter("Autocad has new updates", "Autocad", "Solidworks");
...
isSpam("spam folder is here");
isSpam("advertisement folder is here");
...
containsNumber("abcde123");
containsNumber("defgh");
...
padString("Sevgi", 10);  // Sevgi*****
padString("JavaScript", 5);  // JavaScript
...
findWordPosition("Apple is red", "red"); 
findWordPosition("I love CSS", "JS"); 
