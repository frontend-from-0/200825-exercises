...
const numberDown = 3.7;
const numberUp = 3.2;
console.log('Ex. 12:', '3.7 (floor):', Math.floor(numberDown));
...
console.log('Ex. 15:', 'Points after addition:', points);
...
const y17 = 10;
const z17 = 15;
const totalSum = x17 + y17 + z17;
console.log('Ex. 17:', 'Total sum:', totalSum);
...
console.log('Ex. 18:', 'Quotient (10/3):', quotient, 'Difference (10-3):', difference);
...
console.log('Ex. 20:', 'Product (7*2):', product);
...
let counter22 = 0;
console.log('Ex. 22: Initial:', counter22);

// Method 1
counter22++; 
console.log('Ex. 22: After counter++:', counter22);

// Method 2
counter22 += 1; 
console.log('Ex. 22: After counter+=1:', counter22);

// Method 3
counter22 = counter22 + 1; 
console.log('Ex. 22: After counter=counter+1:', counter22);

// 23. Declare initialTemperature=20. Increase it by 5 and log the result.
let initialTemperature = 20;
initialTemperature += 5; // or initialTemperature = initialTemperature + 5;
console.log('Ex. 23:', 'New Temperature:', initialTemperature);
...
let numberEx26 = -3;
const finalValue = (++numberEx26) * 2; 
console.log('Ex. 26:', 'Final value:', finalValue);
