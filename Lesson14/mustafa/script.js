...
console.log('Ex. 7:', concatenatedString);

// 8. Check the type of a variable, e.g., let x = 42. Log the type using typeof.
let X = 42;
console.log('Ex. 8:', 'Type of variable X is ', typeof X);
...
console.log('Ex. 12:', 'Math.floor(3.7)=', Math.floor(num1), 'Math.ceil(3.2)=', Math.ceil(num2));
...
console.log('Ex. 21:', 'Value of Math.PI=', Math.PI);
...
console.log('Ex. 22:', 'After counter++=', counterEx22);

counterEx22 += 1;
console.log('Ex. 22:', 'After counter+=1=', counterEx22);

counterEx22 = counterEx22 + 1;
console.log('Ex. 22:', 'After counter=counter+1=', counterEx22);

// 23. Declare initialTemperature=20. Increase it by 5 and log the result.
let initialTemperature = 20;
initialTemperature += 5;

console.log('Ex. 23:', 'Increased Temperature=', initialTemperature);

// 24. Declare numberEx9=6. Increment it using the prefix ++ operator and log both the variable and the incremented value.
let numberEx9 = 6;
console.log('Ex. 24:', 'Before increment:', numberEx9);
let incrementedValue = ++numberEx9;
console.log('Ex. 24:', 'After prefix ++ increment:', incrementedValue);

// 25. Declare numberEx10=8. Increment it using the postfix ++ operator and log both the original variable and the incremented value.
let numberEx10 = 8;
console.log('Ex. 25:', 'Before increment:', numberEx10);
let incrementedValuePostfix = numberEx10++;
console.log('Ex. 25:', 'After postfix ++ increment:', numberEx10);

// 26. Declare numberEx11=-3. Increment it by 1 using prefix ++, then multiply the result by 2 and log the final value.
let numberEx11 = -3;
let incrementedNumberEx11 = ++numberEx11;
let finalValueEx11 = incrementedNumberEx11 * 2;
console.log('Ex. 26:', 'Final value after prefix ++ and multiplication:', finalValueEx11);

// 27. Declare a=2 and b=3. Increment a using the prefix ++ operator, then add b to the result and log it.
let aEx27 = 2;
let bEx27 = 3;
let incrementedAEx27 = ++aEx27;
let sumEx27 = incrementedAEx27 + bEx27;
console.log('Ex. 27:', 'Sum after prefix ++ on a and adding b:', sumEx27);