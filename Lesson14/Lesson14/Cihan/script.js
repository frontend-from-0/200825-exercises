...
console.log(`Ex.12 
Round down the number 3.7 by using Math.floor: ${Math.floor(3.7)}
Round up the number 3.2 by using Math.ceil: ${Math.ceil(3.2)}`);
...
console.log('Ex.17 ', 'Sum of the numbers= ', xx + y + z);
...
console.log('Ex.18 ', '10 divided by 3', 'quotient= ', divisionResult, 'difference= ', differenceResult);
...
console.log('Ex.20 ', '7 x 2 = ', product );

// 21. Log the value of Math.PI.

console.log('Ex.21 ', 'Value of the PI number = ', Math.PI);
...
console.log('Ex.22 ', counterr+= 1);
console.log('Ex.22 ', counterr = counterr + 1);
...
let numberEx9 = 6;
console.log('Ex.24 ', 'number= ', numberEx9, 'incremented value= ', ++numberEx9);

// 25. Declare numberEx10=8. Increment it using the postfix ++ operator and log both the original variable and the incremented value.
let numberEx10 = 8;
console.log('Ex.25 ', 'number= ', numberEx10, 'incremented value= ', numberEx10++);

// 26. Declare numberEx11=-3. Increment it by 1 using prefix ++, then multiply the result by 2 and log the final value.
let numberEx11 = -3;
console.log('Ex.26 ', 'Final value after incrementing -3 and multiplying 2 is ', (++numberEx11)*2);
...
console.log('Ex.27 ', 'Result= ', incA + bb);
