...
const roundedUp = Math.ceil(num2);

console.log('Ex. 12', `${num1} rounded to ${roundedDown}`);
console.log('Ex. 12', `${num2} rounded to ${roundedUp}`);
...
console.log('Ex. 16', `${name2} (${age}) lives in ${city}.`);
...
console.log('Ex. 18', 'divison', divisionResult, 'difference:', differenceResult);
...
const counter1 = 0;
let tempCounter = counter1;

tempCounter++;
console.log('Ex. 22', 'counter++:', tempCounter);

tempCounter += 1;
console.log('Ex. 22', 'counter+=1:', tempCounter);

tempCounter = tempCounter + 1;
console.log('Ex. 22', 'counter=counter+1:', tempCounter);
...
let numberEx9 = 6;
console.log('Ex. 24', 'Original:', numberEx9);
console.log('Ex. 24', 'Incremented:', ++numberEx9);

// 25. Declare numberEx10=8. Increment it using the postfix ++ operator and log both the original variable and the incremented value.
let numberEx10 = 8;
console.log('Ex. 25', 'Original:', numberEx10);
console.log('Ex. 25', 'Incremented:', numberEx10++);
console.log('Ex. 25', 'Incremented value:', numberEx10);

// 26. Declare numberEx11=-3. Increment it by 1 using prefix ++, then multiply the result by 2 and log the final value.
let numberEx11 = -3;
const incrementedAndMultiplied = ++numberEx11 * 2;
console.log('Ex. 26', 'Final value:', incrementedAndMultiplied);

// 27. Declare a=2 and b=3. Increment a using the prefix ++ operator, then add b to the result and log it.
let a2 = 2;
const b2 = 3;
const resultEx27 = ++a2 + b2;
console.log('Ex. 27', 'Result:', resultEx27);
