...
console.log('Ex.7', `${string1} ${string2}`);
...
console.log('Ex.18', `The result is:`, divisionResult);
console.log('Ex.18', `The result is:`, differenceResult);

// 19. Declare firstName and lastName. Create fullName by concatenating them with a space and log it.

const firstName = 'Burcu';
const lastName = 'Kayan';

console.log('Ex.19', `The full name is:`, `${firstName} ${lastName}`);
...
let numberEx9=6;
console.log('Ex.24', 'Original numberEx9:', numberEx9);
console.log('Ex.24', 'Incremented numberEx9:', ++numberEx9);
...
let a2=2;
let b2=3;
const incrementedA = ++a2;
const sumResult = incrementedA + b2;
console.log('Ex.27', 'The sum is:', sumResult);