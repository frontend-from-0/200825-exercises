...
function sortContacts() {
  const contacts = [
    ...
    { name: 'John', phone: '123 456 789', email: 'john@gmail.com' },
    { name: 'Jane Doe', phone: '032 889 789', email: 'jane@blabla.com' },
    { name: 'Cihan Kılıç', phone: '032 779 798', email: 'cihan@blabla.com' },
    { name: 'Çağlar Tor', phone: '101 779 888', email: 'caglar@blabla.com' },
    { name: 'Çiğdem Gel', phone: '101 779 888', email: 'cigdem@blabla.com' },
  ];

  function compareByName(a, b) {
    let nameA = a.name.toLowerCase();
    let nameB = b.name.toLowerCase();
    let list = nameA.localeCompare(nameB, "tr");
    return list;
  }
...
console.table(sortContacts());

//but I cheated :( because I can't sorted the array.